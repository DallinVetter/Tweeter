...
public class MainPresenter {
    ...
    private class GetFollowingCountObserver extends ParentCountObserver {
        @Override
    ...
    private class GetFollowerCountObserver extends ParentCountObserver {
        @Override
        public void handleCountSuccess(int count) {
    ...
    public abstract class ParentSimpleNotificationObserver implements SimpleNotificationObserver {
        @Override
    ...
    private class LogoutObserver extends ParentSimpleNotificationObserver {
        @Override
    ...
    private class FollowObserver extends ParentSimpleNotificationObserver {
        @Override
        public void handleSimpleSuccess() {
    ...
    private class UnfollowObserver extends ParentSimpleNotificationObserver {
        @Override
        public void handleSimpleSuccess() {
            updateSelectedUserFollowingAndFollowers(user);
    ...
    private class IsFollowerObserver implements edu.byu.cs.tweeter.client.backgroundTask.observer.IsFollowerObserver {
